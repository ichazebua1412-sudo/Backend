...
export const TodoModel = {
  ...
  }, // <-- PAKE KOMA (,) UNTUK MENAMBUNG METHOD BERIKUTNYA
  ...
  }, // <-- PAKE KOMA (,) BUKAN TITIK KOMA (;)

  // Method delete untuk dihapus oleh todoController
...
}; // <-- KURUNG PENUTUP OBJEK TODOMODEL BARU DI SINI